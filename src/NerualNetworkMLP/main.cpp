...
std::string weights="/Users/jcraster/MLP/src/NerualNetworkMLP/weights/weight_l2_2epoch_78_2703.txt";
    ...
    std::cout<<"tp: "<<gnn.metrics().solutions.tp<<std::endl;
    std::cout<<"tn: "<<gnn.metrics().solutions.tn<<std::endl;
    std::cout<<"fp: "<<gnn.metrics().solutions.fp<<std::endl;
    std::cout<<"fn: "<<gnn.metrics().solutions.fn<<std::endl;
    std::cout<<"seconds: "<<gnn.metrics().seconds<<std::endl;
    std::cout<<"f-measure: "<<gnn.metrics().fMeasure<<std::endl;
    std::cout<<"presition: "<<gnn.metrics().precision<<std::endl;
    std::cout<<"recall: "<<gnn.metrics().recall<<std::endl;
    std::cout<<"accuracy: "<<gnn.metrics().accuracy<<std::endl;
    return 0;
//    std::string str2="/Users/jcraster/MLP/datasets/emnist-letters-test.csv";
//    std::string str1="/Users/jcraster/MLP/datasets/train.txt";
